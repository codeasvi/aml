...
if page == "Dashboard":
    ...
    st.subheader("AML Overview Dashboard")
...
# -----------------------------
    ...
    st.subheader("Transaction Monitoring Engine")

    st.write("Rule-Based + ML Detection Results")
...
# -----------------------------
    ...
    st.subheader("Risk-Based AML Scoring")
